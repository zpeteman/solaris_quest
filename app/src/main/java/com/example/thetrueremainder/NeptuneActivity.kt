...
class NeptuneActivity : AppCompatActivity() {
    ...
    private val orbitPeriodMillis = 60190 * 24 * 60 * 60 * 1000L // 225 days in milliseconds


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_neptune) // Set the layout for this activity
    ...
    private fun showNotification() {
        ...
        NotificationUtils.showNotification(this, "Neptune Completed Orbit", "Congratulations! Neptune completed its orbit around you successfully, your Majesty.")
    }
}