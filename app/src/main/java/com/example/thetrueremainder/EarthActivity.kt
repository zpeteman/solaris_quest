...
class EarthActivity : AppCompatActivity() {
    ...
    private val orbitPeriodMillis = 365 * 24 * 60 * 60 * 1000L // 365 days in milliseconds  30687
    ...
    private fun updateRemainingTime() {
        ...
        // Assumed start date of Mercury's orbit
        ...
        try {
            ...
            // Calculate remaining hours, minutes, and seconds as before
            ...
            val remainingTimeString = "$remainingYears y, $remainingMonthsAfterYears m, ${(remainingDaysAfterMonths / (1000L * 60 * 60 * 24))} d, $remainingHours h, $remainingMinutes m, $remainingSeconds s"
    ...
    private fun showNotification() {
        ...
        NotificationUtils.showNotification(this, "Earth Completed Orbit", "Congratulations! Earth completed its orbit around you successfully, your Majesty.")
    }
}
