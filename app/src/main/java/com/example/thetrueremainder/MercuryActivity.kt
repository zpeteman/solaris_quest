...
class MercuryActivity : AppCompatActivity() {
    ...
    private val orbitPeriodMillis = 88 * 24 * 60 * 60 * 1000L // 88 days in milliseconds


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mercury) // Set the layout for this activity
    ...
    private fun showNotification() {
        ...
        NotificationUtils.showNotification(this, "Mercury Completed Orbit", "Congratulations! Mercury completed its orbit around you successfully, your Majesty.")
    }
}