...
class VenusActivity : AppCompatActivity() {
    ...
    private val orbitPeriodMillis = 225 * 24 * 60 * 60 * 1000L // 225 days in milliseconds


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_venus) // Set the layout for this activity
    ...
    private fun showNotification() {
        ...
        NotificationUtils.showNotification(this, "venus Completed Orbit", "Congratulations! Venus completed its orbit around you successfully, your Majesty.")
    }
}