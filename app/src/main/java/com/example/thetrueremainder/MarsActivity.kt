...
class MarsActivity : AppCompatActivity() {
    ...
    private val orbitPeriodMillis = 687 * 24 * 60 * 60 * 1000L // 225 days in milliseconds


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mars) // Set the layout for this activity
    ...
    private fun showNotification() {
        ...
        NotificationUtils.showNotification(this, "Mars Completed Orbit", "Congratulations! Mars completed its orbit around you successfully, your Majesty.")
    }
}